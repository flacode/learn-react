...
class ProductTable extends Component{
    /* indexOf searches for index of substring, returns first occurance */
    render(){
    ...
    render(){
        ...
        return (
            <form>
                ...
                <p>
                    <input type="checkbox" checked={this.props.inStockOnly} onChange={this.handleInStockChange}/>{' '} Only show products in stocked
                </p> 
            </form>
        );
    }
